...
//  Instructor-dashboard
Route::prefix('dashboard')->middleware(['auth', 'role:instructor'])->group(function () {
...
//  student-dashboard
Route::prefix('dashboard')->middleware(['auth', 'role:student'])->group(function () {
...
Route::prefix('admin')->middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::prefix('users')->name('admin.users.')->group(function () {
        ...
        // ADD USERS SEPARATE FORMS
        Route::get('/create', [UserController::class, 'create'])->name('create');
        Route::post('/store', [UserController::class, 'store'])->name('store');

        // SPECIFIC FORMS
        Route::get('/create/teacher', [UserController::class, 'createTeacher'])->name('create.teacher');
        Route::post('/create/teacher', [UserController::class, 'storeTeacher'])->name('store.teacher');

        Route::get('/create/student', [UserController::class, 'createStudent'])->name('create.student');
        Route::post('/create/student', [UserController::class, 'storeStudent'])->name('store.student');

        Route::get('/create/parent', [UserController::class, 'createParent'])->name('create.parent');
        Route::post('/create/parent', [UserController::class, 'storeParent'])->name('store.parent');

        // EDIT
        Route::get('/{id}/edit', [UserController::class, 'edit'])->name('edit');
        Route::post('/{id}/update', [UserController::class, 'update'])->name('update');

        Route::get('/levels/{level}/grades', [UserController::class, 'getGrades'])->name('getGrades');
        Route::get('/grades/{grade}/subjects', [UserController::class, 'getSubjects'])->name('getSubjects');
