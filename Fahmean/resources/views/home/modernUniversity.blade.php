...
@section('content')
    ...
    <main class="rbt-main-wrapper">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="rbt-banner-item bg_image bg_image--24">
                                <div class="shape-1">
                                    <img src="{{ asset('assets/images/shape/m-banner-shape-01.png') }}" alt="Shape">
                                </div>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="inner">
                                                <h6 class="subtitle"><span><img src="{{ asset('assets/images/icons/trustpilot-white.png') }}" alt="trustpilot"></span>Excellent 4.9 out of 5</h6>
                    ...
                    <div class="row row--40 mt_dec--40">
                        ...
                        <div class="col-xl-6 col-12 mt--40">
                            <div class="about-thumb">
                                <div class="shape-1">
                                    <img src="{{ asset('assets/images/shape/mf-shape-01.png') }}" alt="Shape">
                                </div>
                                <div class="shape-2">
                                ...
                                <div class="since">
                                    <span>
                                        <img src="{{ asset('assets/images/icons/award-01.png') }}" alt="Award Icon">
                                    </span>
                                ...
                                <div class="thumb-1">
                                    <img src="{{ asset('assets/images/others/m-banner-men.png') }}" alt="Thumb">
                                </div>
                                ...
                                <div class="row g-5">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="rbt-card variation-04 rbt-hover">
                                            <div class="rbt-card-img">
                                                <a href="{{ route('courseDetails') }}">
                                                    <img src="{{ asset('assets/images/course/university-01.jpg') }}" alt="Card image">
                                                </a>
                                            </div>
                                            <div class="rbt-card-body">
                                                <ul class="rbt-meta">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="rbt-card variation-04 rbt-hover">
                                            <div class="rbt-card-img">
                                                <a href="{{ route('courseDetails') }}">
                                                    <img src="{{ asset('assets/images/course/university-02.jpg') }}" alt="Card image">
                                                </a>
                                            </div>
                                            <div class="rbt-card-body">
                                                <ul class="rbt-meta">
                                                ...
                                                <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">English Course</a>
                                                </h4>
                                                <p class="rbt-card-text">Orem Ipsum is that it has a more-or-less normal distribution of letters.</p>
                                                <div class="rbt-review">
                                                    <div class="rating">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="rbt-card variation-04 rbt-hover">
                                            <div class="rbt-card-img">
                                                <a href="{{ route('courseDetails') }}">
                                                    <img src="{{ asset('assets/images/course/university-03.jpg') }}" alt="Card image">
                                                </a>
                                            </div>
                                            <div class="rbt-card-body">
                                                <ul class="rbt-meta">
        ...
        <div class="rbt-video-area video-section-02 bg-color-white rbt-section-gap">
            <div class="shape-1">
                <img src="{{ asset('assets/images/shape/v-star.png') }}" alt="Star Shape">
            </div>
            <div class="container">
                <div class="row row--35 align-items-center mt_dec--50">
                    <div class="col-xl-6 col-12 mt--50">
                        <div class="video-popup-wrapper version-02">
                            <div class="v-shape-1">
                                <img src="{{ asset('assets/images/shape/video-dot-01.png') }}" alt="Shape">
                            </div>
                            <div class="feature-1">
                                <img src="{{ asset('assets/images/icons/video-icon-01.png') }}" alt="Icon">
                                <div>
                                    <h5 class="number">99%</h5>
                                    <h6 class="subtitle">Satisfied</h6>
                                </div>
                            </div>
                            <img class="w-100 rbt-radius" src="{{ asset('assets/images/others/video-10.jpg') }}" alt="Video Images">
                ...
                <div class="row g-5 align-items-start">
                    ...
                    <div class="col-lg-5 order-1 order-lg-2">
                        <div class="position-relative">
                            ...
                            <div class="thumbnail">
                                <img class="radius-6" src="{{ asset('assets/images/others/accordion-01.png') }}" alt="histudy image">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="rbt-card variation-02 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="{{ route('courseDetails') }}">
                                    <img src="{{ asset('assets/images/blog/university-blog-01.png') }}" alt="Card image">
                                </a>
                            </div>
                            <div class="rbt-card-body">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="rbt-card variation-02 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="{{ route('courseDetails') }}">
                                    <img src="{{ asset('assets/images/blog/university-blog-02.png') }}" alt="Card image">
                                </a>
                            </div>
                            <div class="rbt-card-body">
