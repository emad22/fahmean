                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-12">
                                <div class="modern-course-features-box h-100">
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <img src="{{ asset('assets/images/course/course-feature-03.jpg') }}" alt="Image">
                                        </div>
                                        <div class="content">
                            ...
                            <div class="col-lg-6">
                                <div class="modern-course-features-box one-colume-grid h-100">
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <img src="{{ asset('assets/images/course/course-feature-01.jpg') }}" alt="Image">
                                        </div>
                                        <div class="content">
                                                ...
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide">
                                                        <div class="thumbnail mt--0">
                                                            <img src="{{ asset('assets/images/course/course-feature-02.jpg') }}" alt="Image">
                                                        </div>
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <div class="thumbnail mt--0">
                ...
                <div class="col-lg-6">
                    <div class="feature-course-thumbnail">
                        <div class="video-popup-wrapper rbt-shadow-box">
                            <img class="w-100 radius-10" src="{{ asset('assets/images/course/course-content.jpg') }}" alt="Card image">
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <div class="video-popup-wrapper">
                        <img class="w-100 rbt-radius" src="{{ asset('assets/images/others/video-05.jpg') }}" alt="Video Images">
