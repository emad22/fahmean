...
@section('content')
    ...
    <main class="rbt-main-wrapper">
        ...
        <div class="rbt-banner-area rbt-banner-26">
            <div class="wrapper">
                <div class="shape-wrapper">
                    <div class="shape-1">
                        <img data-parallax='{"x": 0, "y": -80}' src="{{ asset('assets/images/shape/i-shape-1.png') }}" alt="Banner Shape">
                    </div>
                    <div class="shape-2">
                        <img data-parallax='{"x": 0, "y": -80}' src="{{ asset('assets/images/shape/i-shape-2.png') }}" alt="Banner Shape">
                    </div>
                    <div class="star-1 scene">
                        <span data-depth="2">
                            <img src="{{ asset('assets/images/shape/i-star.png') }}" alt="Banner Shape">
                        </span>
                    </div>
                    <div class="moon scene">
                        <span data-depth="1">
                            <img src="{{ asset('assets/images/shape/i-moon.png') }}" alt="Banner Shape">
                        </span>
                    </div>
                    <div class="quran scene">
                        <span data-depth="1">
                            <img src="{{ asset('assets/images/shape/i-book.png') }}" alt="Banner Shape">
                        </span>
                    </div>
                    <div class="banner">
                        <img data-parallax='{"x": 0, "y": 60}' src="{{ asset('assets/images/shape/i-mosque.png') }}" alt="Banner Shape">
                    </div>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-xl-7">
                            <div class="inner">
                                <h6 class="subtitle"><img src="{{ asset('assets/images/shape/i-graduation.png') }}" alt="Banner Icon"> Learn Quran For Peace</h6>
                                <h1 class="title">Guided By The Quran <img src="{{ asset('assets/images/shape/i-text-book.png') }}" alt="Banner Text"> And Sunnah</h1>
                        ...
                        <div class="col-xl-5">
                            <div class="rbt-banner-26-thumbnails">
                                <div class="shape-dot scene">
                                    <span data-depth="1">
                                        <img src="{{ asset('assets/images/shape/i-dots.png') }}" alt="Banner Shape">
                                    </span>
                                </div>
                                <div class="main-img">
                                    <img src="{{ asset('assets/images/banner/i-arabian.png') }}" alt="Banner Men">
                                </div>
                                ...
                                <div class="rbt-banner-26-album">
                                    <span class="icon">
                                        <img src="{{ asset('assets/images/shape/i-album.png') }}" alt="Banner Icon">
                                    </span>
                                    <div class="cont">
                                ...
                                <div class="rbt-banner-26-team">
                                    <div class="team-cont">
                                        <span class="icon">
                                            <img src="{{ asset('assets/images/shape/i-read-quran.png') }}" alt="Banner Icon">
                                        </span>
                                        <div class="cont">
        ...
        <div class="rbt-about-area rbt-section-gap3Top rbt-section-gapBottom">
            <div class="about-style-4 version-03">
                <div class="light-shadow">
                    <img src="{{ asset('assets/images/shape/a-light-shape.png') }}" alt="Shape">
                </div>
                <div class="dubble-shape">
                    <img src="{{ asset('assets/images/shape/a-dubble-shape.png') }}" alt="Shape">
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-12">
                            <div class="about-thumb">
                                <div class="stars">
                                    <img src="{{ asset('assets/images/shape/a-all-star.png') }}" alt="">
                                </div>
                                <div class="thumb-1">
                                    <img data-parallax='{"x": 0, "y": -30}' src="{{ asset('assets/images/others/arabian.png') }}" alt="Feature">
                                </div>
                                <div class="thumb-2">
                                    <img data-parallax='{"x": 0, "y": 30}' src="{{ asset('assets/images/others/read-quran.png') }}" alt="Feature">
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-12">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="rbt-card variation-04 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="{{ route('courseDetails') }}">
                                    <img src="{{ asset('assets/images/course/quran-course-01.jpg') }}" alt="Card image">
                                </a>
                            </div>
                            <div class="rbt-card-body">
                                <ul class="rbt-meta">
                                ...
                                <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Learn Quran Online</a>
                                </h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="rbt-card variation-04 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="{{ route('courseDetails') }}">
                                    <img src="{{ asset('assets/images/course/quran-course-02.jpg') }}" alt="Card image">
                                </a>
                            </div>
                            <div class="rbt-card-body">
                                <ul class="rbt-meta">
                                ...
                                <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Learn Prayer (Salat)</a>
                                </h4>
                                <p class="rbt-card-text">Orem Ipsum is that it has a more-or-less normal distribution of letters.</p>
                                <div class="rbt-review">
                                    <div class="rating">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="rbt-card variation-04 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="{{ route('courseDetails') }}">
                                    <img src="{{ asset('assets/images/course/quran-course-03.jpg') }}" alt="Card image">
                                </a>
                            </div>
                            <div class="rbt-card-body">
                                <ul class="rbt-meta">
                                ...
                                <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Learn Hadith Change..</a>
                                </h4>
                                <p class="rbt-card-text">Orem Ipsum is that it has a more-or-less normal distribution of letters.</p>
                                <div class="rbt-review">
                                    <div class="rating">
                ...
                <div class="row row--30 mt_dec--30">
                    ...
                    <div class="col-lg-6 mt--30">
                        <div class="accordion-thumbnail">
                            <div class="moon">
                                <img src="{{ asset('assets/images/shape/faq-moon.png') }}" alt="Moon">
                            </div>
                            <div class="shape">
                                <img src="{{ asset('assets/images/shape/a-dubble-shape.png') }}" alt="Shape">
                            </div>
                            <div class="thumb-1">
                                <img data-parallax='{"x": 0, "y": -30}' src="{{ asset('assets/images/others/faq-01.png') }}" alt="Thumbnail">
                            </div>
                            <div class="thumb-2">
                                <img data-parallax='{"x": 0, "y": 30}' src="{{ asset('assets/images/others/faq-02.png') }}" alt="Thumbnail">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row row--15 mt_dec--30">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                        <div class="team">
                            <div class="thumbnail"><img src="{{ asset('assets/images/team/team-11.png') }}" alt="Blog Images">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                        <div class="team">
                            <div class="thumbnail"><img src="{{ asset('assets/images/team/team-12.png') }}" alt="Blog Images">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                        <div class="team">
                            <div class="thumbnail"><img src="{{ asset('assets/images/team/team-13.png') }}" alt="Blog Images">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                        <div class="team">
                            <div class="thumbnail"><img src="{{ asset('assets/images/team/team-14.png') }}" alt="Blog Images">
                            </div>
                            <div class="content">
        ...
        <div class="rbt-testimonial-area rbt-testimonial-shapes-2 bg-color-white rbt-section-gap">
            <div class="shapes">
                <div class="star">
                    <img src="{{ asset('assets/images/shape/t-star.png') }}" alt="Star">
                </div>
                <div class="dubble-shape">
                    <img src="{{ asset('assets/images/shape/a-dubble-shape.png') }}" alt="Shape">
                </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="rbt-card variation-02 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="{{ route('courseDetails') }}">
                                    <img src="{{ asset('assets/images/blog/islamic-blog-01.png') }}" alt="Card image"> </a>
                            </div>
                            <div class="rbt-card-body">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="rbt-card variation-02 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="{{ route('courseDetails') }}">
                                    <img src="{{ asset('assets/images/blog/islamic-blog-02.png') }}" alt="Card image"> </a>
                            </div>
                            <div class="rbt-card-body">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="rbt-card variation-02 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="{{ route('courseDetails') }}">
                                    <img src="{{ asset('assets/images/blog/islamic-blog-03.png') }}" alt="Card image"> </a>
                            </div>
                            <div class="rbt-card-body">
        ...
        <footer class="rbt-footer footer-style-1 footer-islamic bg-color-white overflow-hidden">
            <div class="shape-bg">
                <img data-parallax='{"x": 0, "y": 120}' src="{{ asset('assets/images/shape/islamic-footer-bg.png') }}" alt="Background Image">
            </div>
            <div class="moon">
                <img src="{{ asset('assets/images/shape/i-moon.png') }}" alt="Moon">
            </div>
            <div class="star">
                <img src="{{ asset('assets/images/shape/i-star.png') }}" alt="Star">
            </div>
