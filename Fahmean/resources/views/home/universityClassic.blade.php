...
@section('content')
    ...
    <div class="rbt-slider-main-wrapper position-relative">
        ...
        <div class="swiper rbt-swiper-thumb rbtmySwiperThumb">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="{{ asset('assets/images/banner/banner-small-01.png') }}" alt="Banner Images">
                </div>
                <div class="swiper-slide">
                    <img src="{{ asset('assets/images/banner/banner-small-02.png') }}" alt="Banner Images">
                </div>
                <div class="swiper-slide">
                    <img src="{{ asset('assets/images/banner/banner-small-03.png') }}" alt="Banner Images">
                </div>
            </div>
        </div>
        <!-- End Banner Area  -->
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <div class="video-popup-wrapper">
                        <img class="w-100 rbt-radius" src="{{ asset('assets/images/others/video-06.jpg') }}" alt="Video Images">
                    ...
                    <div class="swiper viral-banner-activation rbt-arrow-between">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="thumbnail">
                                    <a href="#">
                                        <img class="rbt-radius w-100" src="{{ asset('assets/images/banner/hi_2.png') }}" alt="Banner Images">
                                    </a>
                                </div>
                            </div>
                            <!-- End Single Banner  -->
                            ...
                            <div class="swiper-slide">
                                <div class="thumbnail">
                                    <a href="#">
                                        <img class="rbt-radius w-100" src="{{ asset('assets/images/banner/hi_1.png') }}" alt="Banner Images">
                                    </a>
                                </div>
                            </div>
                            <!-- End Single Banner  -->
                            ...
                            <div class="swiper-slide">
                                <div class="thumbnail">
                                    <a href="#">
                                        <img class="rbt-radius w-100" src="{{ asset('assets/images/banner/hi_3.png') }}" alt="Banner Images">
                                    </a>
                                </div>
                            </div>
                            <!-- End Single Banner  -->
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="rbt-category-gallery">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{ asset('assets/images/gallery/gallery-05.jpg') }}" alt="Gallery Images">
                                <div class="rbt-bg-overlay"></div>
                            </a>
                            <div class="hover-content">
            ...
            <div class="row g-5 mt--30">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12 mt--30">
                    <div class="rbt-card variation-02 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="{{ route('blogDetails') }}">Is University The Most Trending
                                    Thing Now?</a></h5>
    ...
    <div class="rbt-gallery-area">
        <div class="row g-0 parent-gallery-container">
            ...
            <a href="{{ asset('assets/images/gallery/gallery-thumb-02.jpg') }}" class="child-gallery-single col-lg-2 col-md-4 col-sm-6 col-6">
                <div class="rbt-gallery">
                    <img class="w-100" src="{{ asset('assets/images/gallery/gallery-thumb-02.jpg') }}" alt="Gallery Images">
                </div>
            </a>
            <a href="{{ asset('assets/images/gallery/gallery-thumb-03.jpg') }}" class="child-gallery-single col-lg-2 col-md-4 col-sm-6 col-6">
                <div class="rbt-gallery">
                    <img class="w-100" src="{{ asset('assets/images/gallery/gallery-thumb-03.jpg') }}" alt="Gallery Images">
                </div>
            </a>
            <a href="{{ asset('assets/images/gallery/gallery-thumb-04.jpg') }}" class="child-gallery-single col-lg-2 col-md-4 col-sm-6 col-6">
                <div class="rbt-gallery">
                    <img class="w-100" src="{{ asset('assets/images/gallery/gallery-thumb-04.jpg') }}" alt="Gallery Images">
                </div>
            </a>
            <a href="{{ asset('assets/images/gallery/gallery-thumb-05.jpg') }}" class="child-gallery-single col-lg-2 col-md-4 col-sm-6 col-6">
                <div class="rbt-gallery">
                    <img class="w-100" src="{{ asset('assets/images/gallery/gallery-thumb-05.jpg') }}" alt="Gallery Images">
                </div>
            </a>
            <a href="{{ asset('assets/images/gallery/gallery-thumb-06.jpg') }}" class="child-gallery-single col-lg-2 col-md-4 col-sm-6 col-6">
                <div class="rbt-gallery">
                    <img class="w-100" src="{{ asset('assets/images/gallery/gallery-thumb-06.jpg') }}" alt="Gallery Images">
                </div>
            </a>
            <a href="{{ asset('assets/images/gallery/gallery-thumb-07.jpg') }}" class="child-gallery-single col-lg-2 col-md-4 col-sm-6 col-6">
                <div class="rbt-gallery">
                    <img class="w-100" src="{{ asset('assets/images/gallery/gallery-thumb-07.jpg') }}" alt="Gallery Images">
                </div>
            </a>
            <a href="{{ asset('assets/images/gallery/gallery-thumb-08.jpg') }}" class="child-gallery-single col-lg-2 col-md-4 col-sm-6 col-6">
                <div class="rbt-gallery">
                    <img class="w-100" src="{{ asset('assets/images/gallery/gallery-thumb-08.jpg') }}" alt="Gallery Images">
                </div>
            </a>
            <a href="{{ asset('assets/images/gallery/gallery-thumb-09.jpg') }}" class="child-gallery-single col-lg-2 col-md-4 col-sm-6 col-6">
                <div class="rbt-gallery">
                    <img class="w-100" src="{{ asset('assets/images/gallery/gallery-thumb-09.jpg') }}" alt="Gallery Images">
                </div>
            </a>
            <a href="{{ asset('assets/images/gallery/gallery-thumb-10.jpg') }}" class="child-gallery-single col-lg-2 col-md-4 col-sm-6 col-6">
                <div class="rbt-gallery">
                    <img class="w-100" src="{{ asset('assets/images/gallery/gallery-thumb-10.jpg') }}" alt="Gallery Images">
                </div>
            </a>
            <a href="{{ asset('assets/images/gallery/gallery-thumb-11.jpg') }}" class="child-gallery-single col-lg-2 col-md-4 col-sm-6 col-6">
                <div class="rbt-gallery">
                    <img class="w-100" src="{{ asset('assets/images/gallery/gallery-thumb-11.jpg') }}" alt="Gallery Images">
                </div>
            </a>
            <a href="{{ asset('assets/images/gallery/gallery-thumb-12.jpg') }}" class="child-gallery-single col-lg-2 col-md-4 col-sm-6 col-6">
                <div class="rbt-gallery">
                    <img class="w-100" src="{{ asset('assets/images/gallery/gallery-thumb-12.jpg') }}" alt="Gallery Images">
                </div>
            </a>
        </div>
    </div>
