                                ...
                                <div class="col-lg-6">
                                    <div class="course-thumbnail">
                                        <a href="{{ route('courseDetails') }}">
                                            <img class="radius-6" src="{{ asset('assets/images/course/course-online-02.jpg') }}" alt="Course Images">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                        ...
                        <div class="swiper-slide">
                            <div class="row gy-5 row--30 align-items-center">
                                <div class="col-lg-6">
                                    <div class="course-thumbnail">
                                        <a href="{{ route('courseDetails') }}">
                                            <img class="radius-6" src="{{ asset('assets/images/course/course-online-04.jpg') }}" alt="Course Images">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                        ...
                        <div class="swiper-slide">
                            <div class="row gy-5 row--30 align-items-center">
                                <div class="col-lg-6">
                                    <div class="course-thumbnail">
                                        <a href="{{ route('courseDetails') }}">
                                            <img class="radius-6" src="{{ asset('assets/images/course/course-online-01.jpg') }}" alt="Course Images">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                        ...
                        <div class="swiper-slide">
                            <div class="row gy-5 row--30 align-items-center">
                                <div class="col-lg-6">
                                    <div class="course-thumbnail">
                                        <a href="{{ route('courseDetails') }}">
                                            <img class="radius-6" src="{{ asset('assets/images/course/course-online-03.jpg') }}" alt="Course Images">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-6">
