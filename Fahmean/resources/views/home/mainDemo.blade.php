            ...
            <nav class="mainmenu-nav">
                <ul class="mainmenu">
                    <li class="with-megamenu has-menu-child-item position-static">
                        <a href="#">???????? <i class="feather-chevron-down"></i></a>
                        <!-- Start Mega Menu  -->
                                ...
                                <div class="row row--15 home-plesentation-wrapper single-dropdown-menu-presentation">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="{{ route('teacherPortfolio', 1) }}"><img src="{{ asset('assets/images/splash/demo/h7.jpg') }}" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                                    <h4 class="title"><a href="{{ route('teacherPortfolio', 1) }}">teacher Portfolio <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                ...
                                                <div class="content">
                                                    <h4 class="title"><a href="{{ '#' }}">???????? ??????? <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <main class="rbt-main-wrapper">
                    ...
                    <div class="col-md-12 pb--120 pt--70">
                        <div class="content">
                            <div class="inner">
                                ...
                                <h1 class="title">
                                    ??????<img src="{{ asset('assets/images/banner/title-h-1.png') }}" style="vertical-align: bottom;"> ??? ?? <br> ??? ???? <img src="{{ asset('assets/images/banner/title-h-2.png') }}">
                                </h1>
                                <p class="description">
                                    ???? ???? ??????? ?????? ??????? ?????? ??????????.. ??? ????? ?????? ?????? 
                                    <strong>?????? ??????.</strong>
                                        ...
                                        <div class="rbt-card variation-01 rbt-hover">
                                            ...
                                            <div class="rbt-card-body">
                                                ...
                                                <div class="rbt-card-bottom">
                                                    ...
                                                    <a class="rbt-btn-link" href="{{ route('courseDetails') }}">????? ??????<i
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title text-center">
                            <span class="subtitle bg-primary-opacity">?????????</span>
                            ...
                            <div class="inner">
                                ...
                                <div class="content">
                                    ...
                                    <div class="read-more-btn">
                                        <span class="rbt-btn-link">25 ????<i class="feather-arrow-right"></i></span>
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="{{ route('courseFilterOneToggle') }}">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h5 class="title">???????? ??????</h5>
                                    <div class="read-more-btn">
                                        <span class="rbt-btn-link">30 ????<i class="feather-arrow-right"></i></span>
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="{{ route('courseFilterOneToggle') }}">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h5 class="title">??????? ???????</h5>
                                    <div class="read-more-btn">
                                        <span class="rbt-btn-link">20 ????<i class="feather-arrow-right"></i></span>
                                    </div>
                                </div>
                            </div>
                        </a>
        ...
        <div class="rbt-course-area bg-color-extra2 rbt-section-gap">
            <div class="container">
                <div class="row mb--60">
                    <div class="col-lg-12">
                        <div class="section-title text-center">
                            <span class="subtitle bg-secondary-opacity">???? ???????? ???????</span>
                            <h2 class="title">???? ??? ?????? ????????? ?? <br /> ??? ??????? ?????????.</h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="rbt-card variation-01 rbt-hover">
                            ...
                            <div class="rbt-card-body">
                                ...
                                <ul class="rbt-meta">
                                    <li><i class="feather-book"></i>20 ???</li>
                                    <li><i class="feather-users"></i>40 ????</li>
                                </ul>
                                ...
                                <div class="rbt-author-meta mb--20">
                                    ...
                                    <div class="rbt-author-info">
                                        ?????? <a href="{{ route('dashboard.index') }}">??????</a> ?? <a href="#">??????</a>
                                    </div>
                                </div>
                                ...
                                <div class="rbt-card-bottom">
                                    ...
                                    <a class="rbt-btn-link" href="{{ route('courseDetails') }}">????? ??????<i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="rbt-card variation-01 rbt-hover">
                            ...
                            <div class="rbt-card-body">
                                ...
                                <ul class="rbt-meta">
                                    <li><i class="feather-book"></i>12 ???</li>
                                    <li><i class="feather-users"></i>50 ????</li>
                                </ul>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="rbt-card variation-01 rbt-hover">
                            ...
                            <div class="rbt-card-body">
                                ...
                                <ul class="rbt-meta">
                                    <li><i class="feather-book"></i>8 ???</li>
                                    <li><i class="feather-users"></i>30 ????</li>
                                </ul>
                    ...
                    <div class="col-lg-6">
                        <div class="inner pl--50 pl_sm--0 pl_md--0">
                            <div class="section-title text-start">
                                <span class="subtitle bg-coral-opacity">??? ??????</span>
                                <h2 class="title">???? ?????? <br /> ????????? ?????????</h2>
                            </div>
                            ...
                            <div class="rbt-feature-wrapper mt--20 ml_dec_20">
                                <div class="rbt-feature feature-style-2 rbt-radius">
                                    ...
                                    <div class="feature-content">
                                        <h6 class="feature-title">????? ???</h6>
                                        <p class="feature-description">??? ?????? ????? ??????? (?????? ???? ????? PDF) ?????? ??????? ?????.</p>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="rbt-counterup rbt-hover-03 border-bottom-gradient">
                            ...
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h3 class="title" style="font-size: 20px; font-weight: 600; margin-bottom: 5px;">????????</h3>
        ...
        <div class="rbt-event-area rbt-section-gap bg-gradient-3">
            <div class="container">
                <div class="row mb--55">
                    <div class="section-title text-center">
                        <span class="subtitle bg-white-opacity">?? ??? ????? ?????????</span>
                        <h2 class="title color-white">????????? ???????? ???????</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <div class="single-slide">
                                        <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                            ...
                                            <div class="rbt-card-body">
                                                ...
                                                <h4 class="rbt-card-title"><a href="{{ '#' }}">?????? ????? ???????? ????? ??????</a></h4>
                ...
                <div class="row g-5 align-items-center mb--30">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="section-title">
                            <span class="subtitle bg-pink-opacity">????? ??????</span>
                            <h2 class="title">???? ???????? ?????????</h2>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12">
                ...
                <div class="row row--15">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 mt--30" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="rbt-card variation-02 height-330 rbt-hover">
                            ...
                            <div class="rbt-card-body">
                                <h3 class="rbt-card-title"><a href="{{ route('blogDetails') }}">?????? ???????</a></h3>
                                <p class="rbt-card-text">???? ??? ???? ????? ?????? ???? ?????? ?????? ??????? ?? ???? ??????.</p>
                                <div class="rbt-card-bottom">
                                    <a class="transparent-button" href="{{ route('blogDetails') }}">???? ??????<i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 mt--30" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        ...
                        <div class="rbt-card card-list variation-02 rbt-hover">
                            ...
                            <div class="rbt-card-body">
                                <h5 class="rbt-card-title"><a href="{{ route('blogDetails') }}">????? ??????? ?????????? ?? ???????? ???????</a></h5>
                                <div class="rbt-card-bottom">
                                    <a class="transparent-button" href="{{ route('blogDetails') }}">???? ??????<i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                                </div>
                            </div>
                ...
                <div class="row row--15 align-items-center">
                    <div class="col-lg-12">
                        <div class="inner text-center">
                            <div class="section-title text-center">
                                <span class="subtitle bg-white-opacity">?? ??? ?? ???? ???????</span>
                                <h2 class="title color-white"><strong>?????</strong> ?? ?????? ????????</h2>
                                <p class="description color-white mt--20">????? ????? ???? ?????? ?????????? ?????? ?????????? ?????? ???????? ?????? ??? ????? ??????????.</p>
                            </div>
                            ...
                            <span class="note-text color-white mt--20">?? ??????? ?????.. ??? ????? ?????? ????.</span>
                                    ...
                                    <div class="rbt-counterup rbt-hover-03 style-2 text-color-white">
                                        <div class="inner">
                                            <div class="content">
                                                ...
                                                <h5 class="title color-white">???? ?????? ?? ??????</h5>
                                                <span class="subtitle color-white">??? ???? ?????? ???????</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
