                                ...
                                <div class="row row--15 home-plesentation-wrapper single-dropdown-menu-presentation">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="{{ route('teacherProfile') }}"><img src="{{ asset('assets/images/splash/demo/h7.jpg') }}" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                                    <h4 class="title"><a href="{{ route('teacherProfile') }}">teacher Portfolio <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <ul class="submenu">
                            <li class="has-dropdown"><a href="#">teacher Dashboard</a>
                                <ul class="submenu">
                                    ...
                                    <li><a href="{{ route('teacherEnrolledCourses') }}">Enrolled Courses</a></li>
                                    <li><a href="{{ route('teacherWishlist') }}">Wishlist</a></li>
                                    <li><a href="{{ route('teacherReviews') }}">Reviews</a></li>
                                    <li><a href="{{ route('teacherMyQuizAttempts') }}">My Quiz Attempts</a></li>
                                    <li><a href="{{ route('teacherOrderHistory') }}">Order History</a></li>
                                    <li><a href="{{ route('teacherCourse') }}">My Course</a></li>
                                    <li><a href="{{ route('teacherAnnouncements') }}">Announcements</a></li>
                                    <li><a href="{{ route('teacherQuizAttempts') }}">Quiz Attempts</a></li>
                                    <li><a href="{{ route('teacherAssignments') }}">Assignments</a></li>
                                    <li><a href="{{ route('teacherSettings') }}">Settings</a></li>
                                </ul>
                            </li>
