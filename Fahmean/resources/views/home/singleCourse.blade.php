                    ...
                    <div class="row row--30 gy-5 align-items-center">
                        <div class="col-lg-6 col-xl-5">
                            <div class="thumbnail rbt-shadow-box">
                                <img class="w-100 radius-10" src="{{ asset('assets/images/course/course-single-01.jpg') }}" alt="Card image">
                            </div>
                        </div>
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-12">
                                <div class="modern-course-features-box h-100">
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <img src="{{ asset('assets/images/course/single-course-02.jpg') }}" alt="Image">
                                        </div>
                                        <div class="content">
                                            ...
                                            <ul class="course-feature-list">
                                                ...
                                                <li>
                                                    <div class="icon">
                                                        <img src="{{ asset('assets/images/icons/card-icon-4.png') }}" alt="Image Icon">
                                                    </div>
                                                    <div class="feature-content">
                            ...
                            <div class="col-lg-6">
                                <div class="modern-course-features-box one-colume-grid h-100">
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <img src="{{ asset('assets/images/course/single-course-06.jpg') }}" alt="Image">
                                        </div>
                                        <div class="content">
                                            ...
                                            <ul class="course-feature-list">
                                                ...
                                                <li>
                                                    <div class="icon">
                                                        <img src="{{ asset('assets/images/icons/card-icon-12.png') }}" alt="Image Icon">
                                                    </div>
                                                    <div class="feature-content">
                                                ...
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide">
                                                        <div class="thumbnail mt--0">
                                                            <img src="{{ asset('assets/images/course/single-course-07.jpg') }}" alt="Image">
                                                        </div>
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <div class="thumbnail mt--0">
                                                            <img src="{{ asset('assets/images/course/single-course-08.jpg') }}" alt="Image">
                                                        </div>
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <div class="thumbnail mt--0">
                                                            <img src="{{ asset('assets/images/course/single-course-09.jpg') }}" alt="Image">
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="col-lg-6">
                    <div class="feature-course-thumbnail">
                        <div class="video-popup-wrapper rbt-shadow-box">
                            <img class="w-100 radius-10" src="{{ asset('assets/images/course/course-elegant-01.jpg') }}" alt="Card image">
                ...
                <div class="single-course-author">
                    <div class="media row align-items-center g-5">
                        <div class="col-lg-3 col-xl-3 offset-xl-2">
                            <div class="thumbnail">
                                <a href="#">
                                    <img class="radius-10 w-100" src="{{ asset('assets/images/team/team-08.jpg') }}" alt="Author Images">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-5">
