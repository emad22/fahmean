        ...
        <div class="wrapper pb--50 rbt-index-upper">
            <div class="container">
                <div class="row g-5 align-items-end mb--60">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="load-more-btn text-start text-lg-end">
                            <a class="rbt-btn btn-border icon-hover radius-round color-white-off" href="{{ route('blog') }}">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 mt--30" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="rbt-card variation-02 rbt-hover card-minimal">
                            <div class="rbt-card-body">
                                ...
                                <h4 class="rbt-card-title"><a href="{{ route('blogDetails') }}">Learn From These You Learn Education.</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 mt--30" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="rbt-card variation-02 rbt-hover card-minimal">
                            <div class="rbt-card-body">
                                ...
                                <h4 class="rbt-card-title"><a href="{{ route('blogDetails') }}">Think You're An Expert In Education?</a></h4>
                                <div class="rbt-card-bottom mt--40">
                                    <a class="transparent-button" href="{{ route('blogDetails') }}">Learn
                                        More<i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 mt--30" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="rbt-card variation-02 rbt-hover card-minimal">
                            <div class="rbt-card-body">
                                ...
                                <h4 class="rbt-card-title"><a href="{{ route('blogDetails') }}">Seven Easy Rules Of Education.</a></h4>
                                <div class="rbt-card-bottom mt--40">
                                    <a class="transparent-button" href="{{ route('blogDetails') }}">Learn
                                        More<i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                                </div>
