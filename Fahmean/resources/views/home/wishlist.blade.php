                                            ...
                                            <div class="row row--15 home-plesentation-wrapper single-dropdown-menu-presentation">
                                                ...
                                                <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                                    <div class="demo-single">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="12-{{ '#' }}"><img src="{{ asset('assets/images/splash/demo/h12.jpg') }}" alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h4 class="title"><a href="12-{{ '#' }}">Marketplace <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <div class="container">
                <div class="section-title-2 text-center with-shape mb--170 mb_lg--100 mb_md--100 mb_sm--100">
                    <div class="shape-1" data-parallax='{"x": 0, "y": 130}'>
                        <img src="{{ asset('assets/images/shape/wishlist-title-bg-shape.png') }}" alt="Shape">
                    </div>
                ...
                <div class="row g-5">
                    ...
                    <!-- Start Single Card  -->
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12" data-sal-delay="0" data-sal="slide-up" data-sal-duration="800">
                        <div class="rbt-card variation-03 style_2">
                            ...
                            <div class="rbt-card-img">
                                <img src="{{ asset('assets/images/course/wishlist-course-01.png') }}" alt="Card image">
                            </div>
                        </div>
                    </div>
                    <!-- End Single Card  -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12" data-sal-delay="0" data-sal="slide-up" data-sal-duration="800">
                        <div class="rbt-card variation-03 style_2">
                            ...
                            <div class="rbt-card-img">
                                <img class="w-100" src="{{ asset('assets/images/course/wishlist-course-02.gif') }}" alt="Card image">
                            </div>
                        </div>
                    </div>
                    <!-- End Single Card  -->
                    ...
                    <!-- Start Single Card  -->
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800">
                        <div class="rbt-card variation-03 style_2">
                            <div class="rbt-card-body">
                            ...
                            <div class="rbt-card-img">
                                <img src="{{ asset('assets/images/course/wishlist-course-03.png') }}" alt="Card image">
                            </div>
                        </div>
                    </div>
                    <!-- End Single Card  -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800">
                        <div class="rbt-card variation-03 style_2">
                            ...
                            <div class="rbt-card-img">
                                <img src="{{ asset('assets/images/course/wishlist-course-04.png') }}" alt="Card image">
                            </div>
                        </div>
                    </div>
                    <!-- End Single Card  -->
                    ...
                    <div class="col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="rbt-card variation-03 style_2 card-horizontal">
                            <div class="rbt-card-body">
                                ...
                                <h5 class="rbt-card-title">I’m <span><img src="{{ asset('assets/images/shape/wishlist-text-shape-01.png') }}" alt="Shape"></span> Always With You, To Solve Any<span><img src="{{ asset('assets/images/shape/wishlist-text-shape-02.png') }}" alt="Shape"></span>Problem</h5>
                            ...
                            <div class="rbt-card-img-wrap">
                                <div class="shape-1">
                                    <img src="{{ asset('assets/images/shape/wishlist-dots.png') }}" alt="Shape">
                                </div>
                                <div class="men-circle">
                                    <img src="{{ asset('assets/images/shape/wishlist-b-men.png') }}" alt="Shape">
                                </div>
                                <div class="rbt-card-img">
                                    <img src="{{ asset('assets/images/course/wishlist-course-05.png') }}" alt="Card image">
                                </div>
                            </div>
                        </div>
                    </div>
