                            ...
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h3 class="counter"><span class="odometer"
                                            data-count="{{ $studentsCount ?? 500 }}">00</span>
                                    </h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--60 mt_md--30 mt_sm--30 mt_mobile--60">
                        <div class="rbt-counterup rbt-hover-03 border-bottom-gradient">
                            ...
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h3 class="counter"><span class="odometer"
                                            data-count="{{ $lessonsCount ?? 800 }}">00</span>
                                    </h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt_md--60 mt_sm--60">
                        <div class="rbt-counterup rbt-hover-03 border-bottom-gradient">
                            ...
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h3 class="counter"><span class="odometer"
                                            data-count="{{ $questionsCount ?? 1000 }}">00</span>
                                    </h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--60 mt_md--30 mt_sm--30 mt_mobile--60">
                        <div class="rbt-counterup rbt-hover-03 border-bottom-gradient">
                            ...
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h3 class="counter"><span class="odometer"
                                            data-count="{{ $coursesCount ?? 100 }}">00</span>
                                    </h3>
                    ...
                    @forelse($courses as $course)
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="{{ route('courseDetails') }}">
                                        <img src="{{ $course->image ? asset($course->image) : asset('assets/images/course/course-01.jpg') }}"
                                            alt="{{ $course->title }}">
                                    </a>
                                </div>
                                <div class="rbt-card-body">
                                    <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">{{ $course->title }}</a>
                                    </h4>
                                    <ul class="rbt-meta">
