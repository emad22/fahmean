                                        ...
                                        <div class="rbt-default-sidebar-wrapper">
                                            ...
                                            <nav class="mainmenu-nav">
                                                <ul class="dashboard-mainmenu rbt-default-sidebar-list">
                                                    <li><a href="{{ '#' }}"><i class="feather-home"></i><span>Dashboard</span></a></li>
                                                    <li><a href="{{ '#' }}"><i class="feather-user"></i><span>My Profile</span></a></li>
                                                    <li><a href="{{ '#' }}"><i class="feather-book-open"></i><span>Enrolled Courses</span></a></li>
                                                    <li><a href="{{ '#' }}"><i class="feather-bookmark"></i><span>Wishlist</span></a></li>
                                                    <li><a href="{{ '#' }}"><i class="feather-star"></i><span>Reviews</span></a></li>
                                                    <li><a href="{{ '#' }}"><i class="feather-help-circle"></i><span>My Quiz Attempts</span></a></li>
                                                    <li><a href="{{ '#' }}"><i class="feather-shopping-bag"></i><span>Order History</span></a></li>
                                                </ul>
                                            </nav>
                                            ...
                                            <nav class="mainmenu-nav">
                                                <ul class="dashboard-mainmenu rbt-default-sidebar-list">
                                                    <li><a href="{{ '#' }}"><i class="feather-monitor"></i><span>My Courses</span></a></li>
                                                    <li><a href="{{ '#' }}"><i class="feather-volume-2"></i><span>Announcements</span></a></li>
                                                    <li><a href="{{ route('instructorQuizAttempts') }}"><i class="feather-message-square"></i><span>Quiz Attempts</span></a></li>
                                                    <li><a href="{{ route('instructorAssignments') }}"><i class="feather-list"></i><span>Assignments</span></a></li>
                                                </ul>
                                            </nav>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-12">
                                                    <div class="rbt-card variation-01 rbt-hover">
                                                        ...
                                                        <div class="rbt-card-body">
                                                            ...
                                                            <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Graphic Courses Club</a>
                                                            </h4>
                                                            <ul class="rbt-meta">
                                                ...
                                                <div class="col-lg-4 col-md-6 col-12">
                                                    <div class="rbt-card variation-01 rbt-hover">
                                                        ...
                                                        <div class="rbt-card-body">
                                                            ...
                                                            <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Wed Design Club</a>
                                                            </h4>
                                                            <ul class="rbt-meta">
                                                                <li><i class="feather-book"></i>20 Lessons</li>
                                                                <li><i class="feather-users"></i>30 Students</li>
