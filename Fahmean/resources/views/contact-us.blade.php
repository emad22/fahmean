...
@section('content')
                        ...
                        <div class="rbt-contact-form contact-form-style-1 max-width-auto fahmean-contact-form-shell">
                            ...
                            <form action="{{ route('contact.send') }}" method="POST" class="max-width-auto" novalidate>
                                ...
                                <div class="freg-grid">
                                    <div class="freg-group freg-line-group {{ old('name') ? 'focused' : '' }}">
                                        <div class="freg-input-wrap">
                                            <input type="text" id="name" name="name" class="freg-input freg-line-input" value="{{ old('name') }}" required>
                                            <label class="freg-floating-label" for="name">الاسم <span class="freg-label-required">*</span></label>
                                    ...
                                    <div class="freg-group freg-line-group {{ old('email') ? 'focused' : '' }}">
                                        <div class="freg-input-wrap">
                                            <input type="email" id="email" name="email" class="freg-input freg-line-input" value="{{ old('email') }}" required dir="ltr">
                                            <label class="freg-floating-label" for="email">البريد الإلكتروني <span class="freg-label-required">*</span></label>
                                            <span class="focus-border"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="freg-group freg-line-group {{ old('subject') ? 'focused' : '' }}">
                                    <div class="freg-input-wrap">
                                        <input type="text" id="subject" name="subject" class="freg-input freg-line-input" value="{{ old('subject') }}" required>
                                        <label class="freg-floating-label" for="subject">عنوان الرسالة <span class="freg-label-required">*</span></label>
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
                                ...
                                <div class="freg-group freg-line-group {{ old('message') ? 'focused' : '' }}">
                                    <div class="freg-input-wrap">
                                        <textarea id="message" name="message" class="freg-input freg-line-textarea" rows="5" required>{{ old('message') }}</textarea>
                                        <label class="freg-floating-label" for="message">الرسالة <span class="freg-label-required">*</span></label>
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
                ...
                <div class="row row--15 mt_dec--30">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 mt--30">
                        <div class="footer-widget">
                            ...
                            <p class="description mt--20">نحن دائمًا نبحث عن الأشخاص الموهوبين والمتحمسين. لا تتردد، قدّم نفسك!</p>
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6 col-12 mt--30">
                        <div class="footer-widget">
                            ...
                            <ul class="ft-link">
                                ...
                                <li><a href="{{ route('becomeTeacher') }}">كن معلماً</a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                        <div class="footer-widget">
                            ...
                            <ul class="ft-link">
                                ...
                                <li><span>البريد الإلكتروني:</span> <a href="mailto:info@ustazy.com">info@ustazy.com</a></li>
    ...
    <style>
        .fahmean-contact-page { overflow: hidden; }
        .fahmean-contact-row { min-height: 920px; }
        .fahmean-contact-form-col { width: 60%; flex: 0 0 60%; max-width: 60%; }
        .fahmean-contact-visual-col { width: 40%; flex: 0 0 40%; max-width: 40%; }
        .fahmean-contact-form-shell { width: 100% !important; max-width: 100% !important; margin: 0; position: relative; z-index: 2; padding: 35px 34px; }
        .fahmean-contact-form-header { margin-bottom: 28px; text-align: center; }
        .fahmean-contact-form-header .title { margin-bottom: 10px; }
        .fahmean-contact-form-header p { margin: 0; color: var(--color-body); font-size: 15px; }
        .freg-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 18px; }
        .freg-group { display: flex; flex-direction: column; margin-bottom: 24px; }
        ...
        .fahmean-contact-visual { position: relative; min-height: 760px; display: flex; align-items: flex-start; justify-content: center; padding: 0; }
        .fahmean-contact-visual-card { width: 100%; max-width: 100%; min-height: 700px; border-radius: 24px; background: linear-gradient(180deg, rgba(158, 220, 251, 0.8) 0%, rgba(185, 236, 255, 0.8) 100%); box-shadow: 0 24px 60px rgba(38, 82, 156, 0.12); display: flex; flex-direction: column; align-items: center; justify-content: flex-start; overflow: hidden; position: relative; padding-top: 20px; }
        .fahmean-contact-visual-card::before,
        .fahmean-contact-visual-card::after { content: ''; position: absolute; border-radius: 50%; background: rgba(255, 255, 255, 0.2); }
        .fahmean-contact-visual-card::before { width: 200px; height: 200px; top: 40px; right: 40px; }
        .fahmean-contact-visual-card::after { width: 120px; height: 120px; top: 220px; left: 48px; }
        .fahmean-contact-visual-header { margin-top: 18px; background: #211644; color: #ff9f10; font-size: 48px; font-weight: 800; line-height: 1.1; border-radius: 999px; padding: 18px 48px; position: relative; z-index: 2; }
        .fahmean-contact-visual-copy { position: relative; z-index: 2; margin-top: 16px; max-width: 520px; text-align: center; font-size: 22px; line-height: 1.8; font-weight: 700; color: #22304d; padding: 0 24px; }
        .fahmean-contact-visual-image-wrap { width: 100%; display: flex; align-items: flex-start; justify-content: center; flex: 1; position: relative; z-index: 2; padding: 0 20px 0; margin-top: 8px; }
        .fahmean-contact-visual-image-wrap img { width: 100%; max-width: 560px; max-height: 430px; object-fit: contain; filter: drop-shadow(0 18px 35px rgba(29, 45, 88, 0.16)); }
        @media (max-width: 1199px) {
            .fahmean-contact-row { min-height: auto; }
            .fahmean-contact-form-col, .fahmean-contact-visual-col { width: 100%; flex: 0 0 100%; max-width: 100%; }
            .fahmean-contact-form-shell { max-width: 100%; padding: 30px 24px; }
            .fahmean-contact-visual { min-height: 620px; padding: 0; }
            .fahmean-contact-visual-card { min-height: 620px; }
            .fahmean-contact-visual-header { font-size: 38px; }
            .fahmean-contact-visual-copy { font-size: 18px; }
        }
        @media (max-width: 991px) {
            .freg-grid { grid-template-columns: 1fr; }
            .fahmean-contact-visual { display: none; }
            .fahmean-contact-form-shell { margin: 0 auto 40px; }
        }
    </style>
