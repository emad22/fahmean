                ...
                <div class="course-grid-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="rbt-card variation-01 rbt-hover card-list-2">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Here's What People Are Education.</a>
                            </h4>
                            <span class="lesson-number">12 lessons <span class="lesson-time">(4 hours total)</span></span>
                ...
                <div class="course-grid-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="rbt-card variation-01 rbt-hover card-list-2">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Seven Great Lessons You Can Learn.</a>
                            </h4>
                            <span class="lesson-number">12 lessons <span class="lesson-time">(4 hours total)</span></span>
                ...
                <div class="course-grid-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="rbt-card variation-01 rbt-hover card-list-2">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Learn From These Mistakes Before.</a>
                            </h4>
                            <span class="lesson-number">12 lessons <span class="lesson-time">(4 hours total)</span></span>
                ...
                <div class="course-grid-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="rbt-card variation-01 rbt-hover card-list-2">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Why Is Everyone Talking About Education?</a>
                            </h4>
                            <span class="lesson-number">12 lessons <span class="lesson-time">(4 hours total)</span></span>
                ...
                <div class="course-grid-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="rbt-card variation-01 rbt-hover card-list-2">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Five Things You Should Do In Education.</a>
                            </h4>
                            <span class="lesson-number">12 lessons <span class="lesson-time">(4 hours total)</span></span>
