            ...
            <div class="rbt-dashboard-content bg-color-white rbt-shadow-box mb--60">
                <div class="content">
                    ...
                    <div class="section-title d-flex justify-content-between align-items-center mb--30">
                        <h4 class="rbt-title-style-3 mb-0">إضافة صلاحية جديدة</h4>
                    ...
                    <form action="{{ route('admin.permissions.store') }}" method="POST">
                        ...
                        <div class="rbt-form-group">
                            <label for="name" class="form-label">اسم الصلاحية (باللغة الإنجليزية) <span class="text-danger">*</span></label>
                            <input type="text" id="name" name="name" class="form-control rbt-custom-input" placeholder="مثال: manage_courses" required>
                            <small class="form-text text-muted">يفضل استخدام حروف صغيرة و underscores (مثال: create_users)</small>
                        ...
                        <div class="form-submit-group mt--40 text-end">
                            ...
                            <button type="submit" class="rbt-btn btn-sm btn-gradient hover-transform-none">
                                <span class="icon-reverse-wrapper">
                                    <span class="btn-text">حفظ الصلاحية</span>
