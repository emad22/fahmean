        ...
        <div class="content">
            ...
            <form action="{{ route($routePrefix . '.update', [$quiz->id, $question->id]) }}" method="POST" class="rbt-default-form">
                ...
                <div class="form-group mb--30">
                    ...
                    <div id="question-editor-container" class="bg-white border-2 radius-10" style="min-height: 150px; direction: rtl; text-align: right;">{!! old('question', $question->question) !!}</div>
