            ...
            <div class="premium-form-card">
                <div class="d-flex justify-content-between align-items-center mb--40">
                    <div>
                        ...
                        <p class="text-muted small">قم بإنشاء مادة دراسية جديدة وربطها بالصف المناسب.</p>
                    </div>
                ...
                <form action="{{ route('admin.subjects.store') }}" method="POST">
                    ...
                    <div class="mb--30">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name" class="form-control radius-end-12" placeholder="مثال: اللغة العربية" required>
                        </div>
                    </div>

                    <div class="mb--40">
                        <label class="form-label fw-bold small text-uppercase mb-2">الصف الدراسي المستهدف</label>
                        <div class="input-group">
                    ...
                    <button class="rbt-btn btn-gradient w-100 radius-10 py-3">
                        <i class="feather-plus-circle me-1"></i> حفظ وتثبيت المادة
                    </button>
                </form>
            </div>
        </div>
