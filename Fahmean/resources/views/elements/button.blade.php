    ...
    <div class="rbt-button-area rbt-section-gapBottom bg-color-white">
        <div class="container">
            ...
            <div class="row mt--50 row--30 gy-5">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="video-popup-wrapper">
                        <img class="w-100 rbt-radius" src="{{ asset('assets/images/others/video-02.jpg') }}" alt="Video Images">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="video-popup-wrapper">
                        <img class="w-100 rbt-radius" src="{{ asset('assets/images/others/video-03.jpg') }}" alt="Video Images">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="video-popup-wrapper">
                        <img class="w-100 rbt-radius" src="{{ asset('assets/images/others/video-04.jpg') }}" alt="Video Images">
