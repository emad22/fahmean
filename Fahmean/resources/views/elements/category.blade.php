        ...
        <div class="container">
            ...
            <div class="row g-5">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                    <a href="{{ route('courseFilterOneToggle') }}" class="rbt-cat-box rbt-cat-box-1 variation-4 text-center">
                        <div class="inner">
                            <div class="icons">
    ...
    <div class="rbt-categories-area bg-color-extra2 rbt-section-gap">
        <div class="container">
            ...
            <div class="row g-5">
                <!-- Start Category Box Layout  -->
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a class="rbt-cat-box rbt-cat-box-1 image-overlaping-content" href="{{ route('courseFilterOneToggle') }}">
                        <div class="inner">
                            <div class="thumbnail">
                                <img src="{{ asset('assets/images/category/image/web-design.jpg') }}" alt="Icons Images">
                            </div>
                ...
                <!-- Start Category Box Layout  -->
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a href="{{ route('courseFilterOneToggle') }}" class="rbt-cat-box rbt-cat-box-1 image-overlaping-content">
                        <div class="inner">
                            <div class="thumbnail">
                                <img src="{{ asset('assets/images/category/image/personal-development.jpg') }}" alt="Icons Images">
                            </div>
                    ...
                    <div class="tab-content" id="myCategoryTabContent">
                        ...
                        <div class="tab-pane fade show active" id="cat-tab-1" role="tabpanel" aria-labelledby="cat-tab-1-tab">
                            <div class="rbt-categori-list medium-size flex-wrap justify-content-center">
                                <a href="{{ route('courseFilterOneToggle') }}">Healthcare</a>
                                <a href="{{ route('courseFilterOneToggle') }}">Beauty &amp; fashion</a>
                                <a href="{{ route('courseFilterOneToggle') }}">Education &amp; Travel</a>
                                <a href="{{ route('courseFilterOneToggle') }}">Kitchen</a>
                                <a href="{{ route('courseFilterOneToggle') }}">Medicle &amp; entertain</a>
                                <a href="{{ route('courseFilterOneToggle') }}">Medicle &amp; Science</a>
                                <a href="{{ route('courseFilterOneToggle') }}">Tour &amp; Travel</a>
                            </div>
                        </div>
