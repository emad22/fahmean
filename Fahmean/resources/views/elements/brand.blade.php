            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <ul class="brand-list brand-style-1">
                        ...
                        <li><a href="#"><img src="{{ asset('assets/images/brand/partner-2.webp') }}" alt="Brand Image"></a></li>
                        <li><a href="#"><img src="{{ asset('assets/images/brand/partner-3.webp') }}" alt="Brand Image"></a></li>
                        <li><a href="#"><img src="{{ asset('assets/images/brand/partner-4.webp') }}" alt="Brand Image"></a></li>
                        ...
                        <li><a href="#"><img src="{{ asset('assets/images/brand/partner-7.webp') }}" alt="Brand Image"></a></li>
                        <li><a href="#"><img src="{{ asset('assets/images/brand/partner-8.webp') }}" alt="Brand Image"></a></li>
                    </ul>
                </div>
            </div>
        </div>
