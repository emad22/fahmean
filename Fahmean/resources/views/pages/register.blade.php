...
@section('content')
                        ...
                        <div class="fahmean-register-visual">
                            <div class="fahmean-register-visual-card">
                                ...
                                <div class="fahmean-register-visual-copy">
                                    ابدأ رحلتك التعليمية على منصة فاهمين وسجّل بياناتك كاملة للانضمام إلى المحتوى والدروس
                                    والمتابعة الأكاديمية.
                                </div>
                                <div class="fahmean-register-visual-image-wrap">
                                    <img src="{{ asset('assets/images/banner/banner-group-image.png') }}"
                    ...
                    <div class="col-lg-8 order-2 order-lg-2 fahmean-register-form-col">
                        <div class="rbt-contact-form contact-form-style-1 max-width-auto fahmean-register-form-shell">
                            <div class="fahmean-register-form-header">
                                ...
                                <p>املأ البيانات التالية للانضمام إلى منصة فاهمين.</p>
                            </div>
                            ...
                            <form action="{{ route('register.post') }}" method="POST" id="freg-form" novalidate>
                                ...
                                <div class="freg-grid">
                                    <div
                                        class="freg-group freg-grid-full freg-line-group {{ old('name') ? 'focused' : '' }}">
                                        <div class="freg-input-wrap">
                                            <input type="text" id="reg_name" name="name" class="freg-input freg-line-input"
                                                value="{{ old('name') }}" autocomplete="name" required>
                                            <label class="freg-floating-label" for="reg_name">الاسم بالكامل <span
                                                    class="freg-label-required">*</span></label>
                                            <span class="focus-border"></span>
                                        </div>
                                        @error('name')<span class="freg-error"><i class="feather-alert-circle"></i>
                                        {{ $message }}</span>@enderror
                                    </div>

                                    <div
                                        class="freg-group freg-grid-full freg-line-group {{ old('email') ? 'focused' : '' }}">
                                        <div class="freg-input-wrap">
                                            <input type="email" id="reg_email" name="email"
                                                class="freg-input freg-line-input" value="{{ old('email') }}"
                                                autocomplete="email" required dir="ltr">
                                            <label class="freg-floating-label" for="reg_email">البريد الإلكتروني <span
                                                    class="freg-label-required">*</span></label>
                                            <span class="focus-border"></span>
                                        </div>
                                        @error('email')<span class="freg-error"><i class="feather-alert-circle"></i>
                                        {{ $message }}</span>@enderror
                                    </div>
                                </div>
                                ...
                                <div class="freg-academic-group">
                                    <div class="freg-group mb--30">
                                        <label class="freg-label">العام الدراسي الحالي <span
                                                class="freg-label-required">*</span></label>
                                        <div class="freg-input-wrap">
                                    ...
                                    <div class="freg-group mb--30">
                                        <label class="freg-label">المرحلة الدراسية <span
                                                class="freg-label-required">*</span></label>
                                        <input type="hidden" name="education_level_id" id="hidden_level_id"
                                            value="{{ old('education_level_id') }}">
                                        ...
                                        @error('education_level_id')<span class="freg-error"><i
                                        class="feather-alert-circle"></i> {{ $message }}</span>@enderror
                                    </div>

                                    <div class="freg-group mb-0">
                                        <label class="freg-label" for="reg_grade">الصف الدراسي <span
                                                class="freg-label-required">*</span></label>
                                        <div class="freg-input-wrap">
                                            <select id="reg_grade" name="grade_id" class="freg-input selectpicker" required
                                                disabled data-live-search="true" title="اختر الصف الدراسي">
                                                <option value="">اختر المرحلة أولاً</option>
                                            </select>
                                            <i class="feather-bookmark freg-input-icon"></i>
                                        </div>
                                        @error('grade_id')<span class="freg-error"><i class="feather-alert-circle"></i>
                                        {{ $message }}</span>@enderror
                                    </div>
                                </div>
                                ...
                                <div class="freg-grid">
                                    <div class="freg-group freg-line-group {{ old('phone_number') ? 'focused' : '' }}">
                                        <div class="freg-input-wrap">
                                            <input type="tel" id="reg_phone" name="phone_number"
                                                class="freg-input freg-line-input" value="{{ old('phone_number') }}"
                                                maxlength="11" dir="ltr" required>
                                            <label class="freg-floating-label" for="reg_phone">رقم هاتف الطالب <span
                                                    class="freg-label-required">*</span></label>
                                            <span class="focus-border"></span>
                                        </div>
                                        @error('phone_number')<span class="freg-error"><i class="feather-alert-circle"></i>
                                        {{ $message }}</span>@enderror
                                    </div>

                                    <div class="freg-group freg-line-group {{ old('parent_phone') ? 'focused' : '' }}">
                                        <div class="freg-input-wrap">
                                            <input type="tel" id="reg_parent_phone" name="parent_phone"
                                                class="freg-input freg-line-input" value="{{ old('parent_phone') }}"
                                                maxlength="11" dir="ltr" required>
                                            <label class="freg-floating-label" for="reg_parent_phone">رقم هاتف ولي الأمر
                                                <span class="freg-label-required">*</span></label>
                                            <span class="focus-border"></span>
                                        </div>
                                        @error('parent_phone')<span class="freg-error"><i class="feather-alert-circle"></i>
                                        {{ $message }}</span>@enderror
                                    </div>
                                </div>
                                    ...
                                    <div class="freg-group freg-line-group {{ old('password') ? 'focused' : '' }}">
                                        <div class="freg-input-wrap">
                                            <input type="password" id="reg_password" name="password"
                                                class="freg-input freg-line-input has-toggle freg-line-password" required
                                                autocomplete="new-password">
                                            <label class="freg-floating-label" for="reg_password">كلمة المرور <span
                                                    class="freg-label-required">*</span></label>
                                            <button type="button" class="freg-pwd-toggle"
                                                onclick="togglePassword('reg_password', this)"><i
                                                    class="feather-eye"></i></button>
                                            <span class="focus-border"></span>
                                        </div>
                                        ...
                                        @error('password')<span class="freg-error"><i class="feather-alert-circle"></i>
                                        {{ $message }}</span>@enderror
                                    </div>
                                    ...
                                    <div class="freg-group freg-line-group">
                                        <div class="freg-input-wrap">
                                            <input type="password" id="reg_password_confirm" name="password_confirmation"
                                                class="freg-input freg-line-input has-toggle freg-line-password" required
                                                autocomplete="new-password">
                                            <label class="freg-floating-label" for="reg_password_confirm">تأكيد كلمة المرور
                                                <span class="freg-label-required">*</span></label>
                                            <button type="button" class="freg-pwd-toggle"
                                                onclick="togglePassword('reg_password_confirm', this)"><i
                                                    class="feather-eye"></i></button>
                                            <span class="focus-border"></span>
                                        </div>
                                        <span class="freg-error" id="pwd-match-error" style="display:none;"><i
                                                class="feather-alert-circle"></i> كلمتا المرور غير متطابقتين</span>
                                    </div>
                                </div>

                                <div class="freg-terms">
                                    <input type="checkbox" id="reg_terms" name="terms" required>
                                    <label for="reg_terms">أوافق على <a href="#">شروط الاستخدام</a> و<a
                                            href="{{ route('privacyPolicy') }}">سياسة
                                            الخصوصية</a> الخاصة بمنصة فاهمين</label>
                                </div>
                                ...
                                <div class="freg-login-link">لديك حساب بالفعل؟ <a href="{{ route('login') }}">سجّل دخولك
                                        الآن</a></div>
                            </form>
                        </div>
                    </div>
    ...
    <style>
        .fahmean-register-page {
            overflow: hidden;
        }

        .fahmean-register-row {
            min-height: 920px;
        }

        .fahmean-register-form-col {
            width: 60%;
            flex: 0 0 60%;
            max-width: 60%;
        }

        .fahmean-register-visual-col {
            width: 40%;
            flex: 0 0 40%;
            max-width: 40%;
        }

        .fahmean-register-form-shell {
            width: 100% !important;
        ...
        .fahmean-register-form-header {
            margin-bottom: 28px;
            text-align: center;
        }

        .fahmean-register-form-header .title {
            margin-bottom: 10px;
        }

        .fahmean-register-form-header p {
            margin: 0;
        ...
        .freg-section-label::after {
            ...
            flex: 1;
            height: 1px;
            background: rgba(69, 98, 155, 0.12);
        }
        ...
        .bootstrap-select>.dropdown-toggle {
            width: 100% !important;
            min-height: 58px;
            border: 1px solid rgba(69, 98, 155, 0.18) !important;
        ...
        .bootstrap-select>.dropdown-toggle:focus {
            ...
            box-shadow: 0 0 0 4px rgba(123, 97, 255, 0.08) !important;
            outline: none;
        }
        ...
        .bootstrap-select .dropdown-menu {
            border-radius: 14px;
            border: 1px solid rgba(69, 98, 155, 0.14);
            box-shadow: 0 18px 35px rgba(31, 31, 37, 0.08);
        }
        ...
        .freg-level-card {
            background: #fff;
            border: 1px solid rgba(69, 98, 155, 0.16);
            border-radius: 16px;
            padding: 16px 12px;
            text-align: center;
            cursor: pointer;
        ...
        .freg-level-card.active {
            border-color: #7b61ff;
            box-shadow: 0 12px 24px rgba(123, 97, 255, 0.12);
        ...
        .freg-btn.loading .icon-reverse-wrapper {
            opacity: 0;
        }
        ...
        .freg-spinner {
            ...
            border-radius: 50%;
            animation: freg-spin 0.8s linear infinite;
            position: absolute;
            top: 50%;
            left: 50%;
        ...
        .fahmean-register-visual-card::before,
        .fahmean-register-visual-card::after {
            content: '';
            position: absolute;
            border-radius: 50%;
        ...
        .fahmean-register-visual-header {
            margin-top: 18px;
            background: #211644;
            color: #ff9f10;
            font-size: 48px;
        ...
        .fahmean-register-visual-image-wrap {
            width: 100%;
            display: flex;
            align-items: flex-start;
            justify-content: center;
        ...
        .fahmean-register-visual-image-wrap img {
            width: 100%;
            max-width: 560px;
            max-height: 430px;
            object-fit: contain;
        ...
        .freg-line-group .freg-input-wrap {
            position: relative;
        }
