                            ...
                            <div class="inner">
                                ...
                                <ul class="rbt-sidebar-list-wrapper recent-post-list">
                                    <li>
                                        <div class="thumbnail">
                                            <a href="{{ '#' }}">
                                                <img src="{{ asset('assets/images/event/grid-type-04.jpg') }}" alt="Event Images">
                                            </a>
                                        </div>
                                        <div class="content">
                                            <h6 class="title"><a href="{{ '#' }}">Elegant Light Box Paper Cut.</a></h6>
                                            <ul class="rbt-meta">
                                    ...
                                    <li>
                                        <div class="thumbnail">
                                            <a href="{{ '#' }}">
                                                <img src="{{ asset('assets/images/event/grid-type-01.jpg') }}" alt="Event Images">
                                            </a>
                                        </div>
                                        <div class="content">
                                            <h6 class="title"><a href="{{ '#' }}">Most Effective Ways Education.</a></h6>
                                            <ul class="rbt-meta">
                                                <li><i class="feather-clock"></i>26 Mar, 2025</li>
                                            </ul>
                                        </div>
                                    ...
                                    <li>
                                        <div class="thumbnail">
                                            <a href="{{ '#' }}">
                                                <img src="{{ asset('assets/images/event/grid-type-02.jpg') }}" alt="Event Images">
                                            </a>
                                        </div>
                                        <div class="content">
                                            <h6 class="title"><a href="{{ '#' }}">Elegant Light Box Paper Cut.</a></h6>
                                    ...
                                    <li>
                                        <div class="thumbnail">
                                            <a href="{{ '#' }}">
                                                <img src="{{ asset('assets/images/event/grid-type-03.jpg') }}" alt="Event Images">
                                            </a>
                                        </div>
                                        <div class="content">
                                            <h6 class="title"><a href="{{ '#' }}">Top 7 Common About Education.</a></h6>
                                            <ul class="rbt-meta">
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-12">
                            <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Histudy Education Fair
                                            2024</a></h4>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-12">
                            <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}"> Elegant Light Box Paper
                                            Cut Dioramas</a></h4>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-12">
                            <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Most Effective Ways
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-12">
                            <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="{{ route('courseDetails') }}">
                                        <img src="{{ asset('assets/images/event/grid-type-06.jpg') }}" alt="Card image">
                                        <div class="rbt-badge-3 bg-white">
                                            <span>11 Oct</span>
                                            <span>2024</span>
                                        </div>
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Top 7 Common About
                                            Education.</a></h4>
