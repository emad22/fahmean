            ...
            <div class="row g-5">
                    ...
                    <div class="rbt-default-card style-three rbt-hover">
                        <div class="inner">
                            <div class="content pt--0 pb--10">
                                <h2 class="title"><a href="{{ '#' }}">Miracle Morning</a></h2>

                                <span class="team-form">
                                    <span class="location">By John Due</span>
                                </span>
                            </div>
                            <div class="thumbnail"><a href="{{ '#' }}"><img src="{{ asset('assets/images/product/1.jpg') }}" alt="Histudy Book Image"></a></div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-default-card style-three rbt-hover">
                        <div class="inner">
                            <div class="content pt--0 pb--10">
                                <h2 class="title"><a href="{{ '#' }}">Happy Strong</a></h2>

                                <span class="team-form">
                                    <span class="location">By John Due</span>
                                </span>
                            </div>
                            <div class="thumbnail"><a href="{{ '#' }}"><img src="{{ asset('assets/images/product/7.jpg') }}" alt="Histudy Book Image"></a></div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-default-card style-three rbt-hover">
                        <div class="inner">
                            <div class="content pt--0 pb--10">
                                <h2 class="title"><a href="{{ '#' }}">Rich Dad Poor Dad</a></h2>

                                <span class="team-form">
                                    <span class="location">By John Due</span>
                                </span>
                            </div>
                            <div class="thumbnail"><a href="{{ '#' }}"><img src="{{ asset('assets/images/product/3.jpg') }}" alt="Histudy Book Image"></a></div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-default-card style-three rbt-hover">
                        <div class="inner">
                            <div class="content pt--0 pb--10">
                                <h2 class="title"><a href="{{ '#' }}">Momentum Theorem</a></h2>

                                <span class="team-form">
                                    <span class="location">By John Due</span>
                                </span>
                            </div>
                            <div class="thumbnail"><a href="{{ '#' }}"><img src="{{ asset('assets/images/product/4.jpg') }}" alt="Histudy Book Image"></a></div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-default-card style-three rbt-hover">
                        <div class="inner">
                            <div class="content pt--0 pb--10">
                                <h2 class="title"><a href="{{ '#' }}">Happy Days</a></h2>

                                <span class="team-form">
                                    <span class="location">By John Due</span>
                                </span>
                            </div>
                            <div class="thumbnail"><a href="{{ '#' }}"><img src="{{ asset('assets/images/product/8.jpg') }}" alt="Histudy Book Image"></a></div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-default-card style-three rbt-hover">
                        <div class="inner">
                            <div class="content pt--0 pb--10">
                                <h2 class="title"><a href="{{ '#' }}">The Road</a></h2>

                                <span class="team-form">
                                    <span class="location">By John Due</span>
                                </span>
                            </div>
                            <div class="thumbnail"><a href="{{ '#' }}"><img src="{{ asset('assets/images/product/6.jpg') }}" alt="Histudy Book Image"></a></div>
                            <div class="content">
