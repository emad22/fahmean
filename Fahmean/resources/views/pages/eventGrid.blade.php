                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-card event-grid-card variation-01 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">International Education Fair
                                    2024</a></h4>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-card event-grid-card variation-01 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Painting Art Contest 2020</a></h4>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-card event-grid-card variation-01 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Histudy Education Fair 2024</a>
                            </h4>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-card event-grid-card variation-01 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}"> Elegant Light Box Paper Cut
                                    Dioramas</a></h4>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-card event-grid-card variation-01 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Most Effective Ways Education's
                                    Problem.</a></h4>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-card event-grid-card variation-01 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="{{ route('courseDetails') }}">Top 7 Common About Education.</a>
                            </h4>
