                        ...
                        <form action="#">
                            ...
                            <div class="cart-table table-responsive mb--60">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="pro-thumbnail"><a href="#"><img src="{{ asset('assets/images/product/1.jpg') }}" alt="Product"></a></td>
                                        ...
                                        <tr>
                                            <td class="pro-thumbnail"><a href="#"><img src="{{ asset('assets/images/product/7.jpg') }}" alt="Product"></a></td>
                                        ...
                                        <tr>
                                            <td class="pro-thumbnail"><a href="#"><img src="{{ asset('assets/images/product/3.jpg') }}" alt="Product"></a></td>
                                        ...
                                        <tr>
                                            <td class="pro-thumbnail"><a href="#"><img src="{{ asset('assets/images/product/4.jpg') }}" alt="Product"></a></td>
