        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="rbt-team team-style-default style-three small-layout rbt-hover">
                        <div class="inner">
                            <div class="thumbnail"><img src="{{ asset('assets/images/team/team-04.jpg') }}" alt="Corporate Template"></div>
                            <div class="content">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="rbt-team team-style-default style-three small-layout rbt-hover">
                        <div class="inner">
                            <div class="thumbnail"><img src="{{ asset('assets/images/team/team-05.jpg') }}" alt="Corporate Template"></div>
                            <div class="content">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="rbt-team team-style-default style-three small-layout rbt-hover">
                        <div class="inner">
                            <div class="thumbnail"><img src="{{ asset('assets/images/team/team-06.jpg') }}" alt="Corporate Template"></div>
                            <div class="content">
