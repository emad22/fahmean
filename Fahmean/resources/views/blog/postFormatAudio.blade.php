            ...
            <div class="blog-content-wrapper rbt-article-content-wrapper">
                ...
                <div class="content">
                    ...
                    <audio class="mb--40" controls="">
                        <source src="{{ asset('http://axilthemes.com/themes/blogar/wp-content/uploads/2021/01/audio.mp3') }}" type="audio/ogg">
                        <source src="{{ asset('http://axilthemes.com/themes/blogar/wp-content/uploads/2021/01/audio.mp3') }}" type="audio/mpeg">
