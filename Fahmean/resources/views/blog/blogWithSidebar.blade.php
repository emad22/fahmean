                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="rbt-blog-grid rbt-card variation-02 rbt-hover">
                                ...
                                <div class="rbt-card-body">
                                    <h5 class="rbt-card-title"><a href="{{ route('blogDetails') }}">The Latest Trend In
                                            Education.</a></h5>

                                    <ul class="blog-meta">
                                        <li><i class="feather-user"></i> admin</li>
                                        <li><i class="feather-clock"></i> August 3, 2024</li>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="rbt-blog-grid rbt-card variation-02 rbt-hover">
                                ...
                                <div class="rbt-card-body">
                                    <h5 class="rbt-card-title"><a href="{{ route('blogDetails') }}">The Modern Rules Of
                                            Education.</a></h5>
                                    <ul class="blog-meta">
                                        <li><i class="feather-user"></i> admin</li>
                                        <li><i class="feather-clock"></i> August 3, 2024</li>
                            ...
                            <div class="inner">
                                ...
                                <ul class="rbt-sidebar-list-wrapper recent-post-list">
                                    ...
                                    <li>
                                        <div class="thumbnail">
                                            <a href="{{ '#' }}">
                                                <img src="{{ asset('assets/images/event/grid-type-06.jpg') }}" alt="Event Images">
                                            </a>
                                        </div>
                                        <div class="content">
                                            <h6 class="title"><a href="{{ '#' }}">Most Effective Ways Education.</a></h6>
                                    ...
                                    <li>
                                        <div class="thumbnail">
                                            <a href="{{ '#' }}">
                                                <img src="{{ asset('assets/images/event/grid-type-05.jpg') }}" alt="Event Images">
                                            </a>
                                        </div>
                                        <div class="content">
                                            <h6 class="title"><a href="{{ '#' }}">Top 7 Common About Education.</a></h6>
